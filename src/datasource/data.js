let virus = [
    ...
    },
    {
        ...
        "sold": true,
        "price": 5000,
        "promotion": [{"discount": 5, "amount": 2, "_id": "6476f0e1c7e21b2b33a35d6d"}, {
            "discount": 10,
            "amount": 5,
            "_id": "6476f0e1c7e21b2b33a35d6e"
        }],
    ...
    },
    {
        ...
        "sold": true,
        "price": 1000,
        "promotion": [{"discount": 10, "amount": 10, "_id": "6476f0e1c7e21b2b33a35d70"}, {
            "discount": 20,
            "amount": 50,
            "_id": "6476f0e1c7e21b2b33a35d71"
        }],
    ...
    },
    {
        ...
        "sold": true,
        "price": 500,
        "promotion": [{"discount": 5, "amount": 5, "_id": "6476f0e1c7e21b2b33a35d73"}, {
            "discount": 10,
            "amount": 10,
            "_id": "6476f0e1c7e21b2b33a35d74"
        }, {"discount": 20, "amount": 50, "_id": "6476f0e1c7e21b2b33a35d75"}],
    ...
    },
    {
        ...
        "sold": true,
        "price": 10000,
        "promotion": [{"discount": 10, "amount": 2, "_id": "6476f0e1c7e21b2b33a35d77"}],
        "object": "{ \"code\": \"ABCACACABCAB\"}"
    },
]
let shopusers = [
    {
        "_id": "66d58122c08b4d64db14cd01",
        "name": "tester user",
        "login": "tester",
        "password": "$2a$10$v4tIpEQnaEJPsRxRiGcN2OGqmlkhZ2qx20COEidbt/EG0uX/.vSWa",
    ...
    },
    {
        ...
        "name": "doctor mad",
        "login": "drmad",
        "password": "$2a$10$NOsxgLgAUS83f.nGsmU2qevDe.mnBpEC0fDHeUOWSY6z/0TprYqPa",
        "email": "drmad@bad.org",
        "orders": [{
            "items": [{
                "item": {
                    ...
                    "object": "{ \"code\": \"ABABABABABAB\"}"
                }, "amount": 2, "_id": "66d58122c08b4d64db14cd06"
            }, {
                "item": {
                    "name": "covid",
...
let transactions = [
    {
        "_id": "64762dc9066dd654632aed59",
        "amount": -10500,
        "account": "64762dc9066dd654632aed53",
    ...
    },
    {
        ...
        "amount": 75000,
        "account": "64762dc9066dd654632aed53",
        "date": {"$date": "2023-05-30T17:09:29.201Z"},
        "uuid": "99990000-0000-0000-0000-000000000002"
    },
    {
        "_id": "64762dc9066dd654632aed5d",
        "amount": -75000,
        "account": "64762dc9066dd654632aed50",
        "date": {"$date": "2023-05-30T17:09:29.202Z"},
        "uuid": "99990000-0000-0000-0000-000000000003"
    },
]
let auctionusers = [
    {
        "_id": "64762dc9066dd654632aed69",
        "pseudo": "drmad",
        "password": "$2a$10$BnPODInoJJJxLcjLDOBL3uHFUQQD9KiM5jfRVoEa0QmTHYSTzL/te",
        "email": "drmad@bad.org",
        "account": "FRDRMAD578901234567890-0000666"
    },
    {
        "_id": "64762dc9066dd654632aed6c",
        "pseudo": "crime1",
        "password": "$2a$10$NApPjAFy68l9TQO6iUIwYueK3hiA80tSdbPUZr5FYl5Aje8GPxHfO",
        "email": "crime1@bad.org",
        "account": "FRBADORG78901234567890-0000001"
    },
    {
        "_id": "64762dc9066dd654632aed6f",
        "pseudo": "crime2",
        "password": "$2a$10$t7JOXL3n/jQdOmJO7Tf71OJMVBCE83rawRTk/Seb./sIQeB9W1qPO",
...
let auctionrequests = [
    {
        ...
        "buyer": "64762dc9066dd654632aed6c",
        "price": 50000,
        "lethality": 10,
        "kidneysVirulence": 1,
        "survival": {"air": 100}
    ...
    {
        "_id": "64762dc9066dd654632aed74",
        "buyer": "64762dc9066dd654632aed6f",
        "price": 10000,
        "lethality": 3,
        "brainVirulence": 2,
        "lungsVirulence": 1,
...
let auctiontransactions = [
    {
        "_id": "64762dc9066dd654632aed77",
        "buyer": {
            "ref": "64762dc9066dd654632aed6c",
            "pseudo": "crime1",
            "email": "crime1@bad.org",
            "account": "FRBADORG78901234567890-0000001"
        },
        "seller": {
            "ref": "64762dc9066dd654632aed69",
            "pseudo": "drmad",
            "email": "drmad@bad.org",
            "account": "FRDRMAD578901234567890-0000666"
        },
        "date": {"$date": "2023-05-30T17:09:29.506Z"},
        "name": "madovirus",
        "price": 75000,
        "lethality": 40,
        "brainVirulence": 9,
